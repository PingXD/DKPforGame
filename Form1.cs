...
namespace DKP
{
    public partial class Form1 : Form
    {
        ...
        {   
            ...
            string constr = string.Format("Database=Exam;Data Source = 69.194.11.204; User Id = root; Password=Abc123.@;CharSet=utf8;port=3306;Allow User Variables=True");
...
            }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (comboBox1.Text == "增加")
            {
                ...
                string constr = string.Format("Database=Exam;Data Source = 69.194.11.204; User Id = root; Password=Abc123.@;port=3306;Allow User Variables=True;CharSet=utf8;");
                MySqlConnection conn = new MySqlConnection(constr);
                conn.Open();
